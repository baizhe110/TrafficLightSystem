...
#define attachPoint "/net/RMIT_BBB_v5_07/dev/name/local/CentralServer"
#define attachPointSem "/net/RMIT_BBB_v5_07/dev/sem/sync"
...
enum intersection_modes CurrentMode, desiredMode, desiredState;
